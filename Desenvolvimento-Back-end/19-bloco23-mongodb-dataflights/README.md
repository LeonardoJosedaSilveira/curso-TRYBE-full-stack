...
Selecionar e contar documentos utilizando filtros simples;
Selecionar e contar documentos utilizando filtros avançados e alguns operadores de comparação;
Construir queries mais complexas juntando operadores de comparação e operadores lógicos.
